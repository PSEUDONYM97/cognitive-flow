...
def main():
    ...
    if args.debug:
        ...
        print("=" * 60)
        print()
        print("  CHANGELOG (oldest to newest):")
        ...
        print("    v1.13.x - Fix pause media detection (pycaw per-session audio meter)")
        print("            - Detects actual audio output from known media players only")
        print()
        print("=" * 60)
